...
class WebsiteExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('anchor_format', [$this, 'anchorFormat']),
            new TwigFilter('camelCaseToFile', [$this, 'convertCamelCaseToFile']),
        ];
    }

    /**
     * Convert camelCase to a string with - instead of whitespace.
     *
     * @param string $name
     *
     * @return string
     */
    public function convertCamelCaseToFile($name)
    {
        $pattern = '/(([A-Z]{1}))/';
    ...
    public function anchorFormat($string)
    {
